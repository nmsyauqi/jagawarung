...
class _DashboardPageState extends State<DashboardPage> {
  ...
  Future<void> _openRealCameraScanner(String idWarung) async {
    ...
    final ProdukModel? scannedProduk = await Navigator.of(context)
        .push<ProdukModel?>(
          MaterialPageRoute(
        ...
        SnackBar(
          content: Row(
            children: [
              ...
              Text(
                'Barcode ${scannedProduk.namaProduk} berhasil di-scan! (BEEP)',
              ),
            ],
          ),
                                        ...
                                        SnackBar(
                                          content: Row(
                                            children: [
                                              ...
                                              const SizedBox(width: 8),
                                              Text(
                                                'Barcode ${p.namaProduk} berhasil di-scan! (BEEP)',
                                              ),
                                            ],
                                          ),
                                          backgroundColor: Colors.green,
...
class _ScannerLaserState extends State<_ScannerLaser>
